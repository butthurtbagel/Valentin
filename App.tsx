          ...
          <div className="max-w-4xl mx-auto relative z-10">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-12">
              <div className="relative group">
                ...
                />
                <div className="absolute -bottom-5 -right-5 bg-white text-black p-4 rounded-full shadow-2xl text-4xl">🎩</div>
              </div>
      ...
      <footer className="bg-white py-24 px-6 text-center">
        <div className="max-w-7xl mx-auto">
          <div className="flex justify-center gap-12 mb-12 text-4xl">
            <span className="cursor-pointer hover:text-[#ff4c68] transition-colors hover:scale-125">🐦</span>
            <span className="cursor-pointer hover:text-[#ff4c68] transition-colors hover:scale-125">📸</span>
            <span className="cursor-pointer hover:text-[#ff4c68] transition-colors hover:scale-125">✉️</span>
          </div>
